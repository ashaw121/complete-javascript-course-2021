...
exports.totalQuantity = exports.totalPrice = void 0;
...
exports.totalQuantity = totalQuantity;
...
console.log('Importing module'); // import { addToCart, totalPrice, totalQuantity } from './ShoppingCart.js';
// addToCart('bread', 5);
...
(0, _shoppingCart.default)("cow's milk", 15);
(0, _shoppingCart.default)('soup', 1);
(0, _shoppingCart.default)('windex', 3);
(0, _shoppingCart.default)('oranges', 2);
console.log(_shoppingCart.cart); // console.log('Fetching');
